...
- Outbound HTTPS access to your AI provider. On on-premises / self-managed databases you will likely need to configure network ACLs and a TLS wallet first — see [Network Setup (ACL & Wallet)](/products/uc-ai/docs/guides/network-setup/).
...
Make sure you are on the **main branch** (not the development branch). Run this script to install the UC AI with any SQL client:
...
Now that UC AI is installed, here is a suggested reading order:
