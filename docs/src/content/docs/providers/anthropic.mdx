...
We generally recomend also setting `Valid for URLs` to the Anthropic API (https://api.anthropic.com/) to limit the scope of the credential.
...
- `uc_ai_anthropic.c_model_claude_4_1_opus` - Most capable model
- `uc_ai_anthropic.c_model_claude_4_sonnet` - Balanced performance and speed
- `uc_ai_anthropic.c_model_claude_4_opus` - Previous generation Opus model
