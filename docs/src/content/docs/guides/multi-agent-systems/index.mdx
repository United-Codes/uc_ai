...
`list_sessions` reads the headers. Use it as the conversation list of a front end:
...
Your front end decides how a title is made. An LLM can summarize the first
...
session, no row matches, and the procedure writes nothing. It writes a warning to
