...
config-driven mechanism as [`generate_text`](/products/uc-ai/docs/api/generate_text#config-driven-variants-p_config). The globals are neither read nor mutated, so other libraries can request embeddings self-contained and re-entrantly:
