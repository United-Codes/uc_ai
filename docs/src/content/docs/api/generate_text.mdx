...
`g_max_tool_calls`, `g_apex_web_credential`, …) plus an optional provider-named nested
object for provider-specific settings. Unknown keys raise `ORA-20503`; an unknown
provider raises `ORA-20306`.
