...
- Added global `uc_ai.g_tool_tags` parameter to filter which tools are available for an AI request.See the [using tools docs section](/products/uc-ai/docs/guides/tools/#using-toolsl) for details
