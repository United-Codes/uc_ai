...
description: Interactive tool for creating JSON schemas
---

import JsonSchemaBuilder from "../../../components/JsonSchemaBuilder.tsx";

This interactive tool creates JSON schemas without writing JSON by hand. Define your properties in the interface below. The tool generates a valid JSON schema.
