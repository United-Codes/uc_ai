...
3. Ensure Oracle database can access the Ollama API endpoint — you still need a network ACL for the Ollama host (e.g. `localhost`), see [Network Setup (ACL & Wallet)](/products/uc-ai/docs/guides/network-setup/)
