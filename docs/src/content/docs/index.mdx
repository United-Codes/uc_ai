...
To get a quick start into what this framework can do, watch our [UC Live webinar](https://youtube.com/live/k4Vt7AKXCnM) where I demonstrate practical AI use cases in PL/SQL. Alternatively, check out Philip's [blog post](https://hartenfeller.dev/blog/real-ai-solutions-oracle-plsql).
