...
As of v26.2, UC AI routes OpenAI calls through the [Responses API](https://platform.openai.com/docs/api-reference/responses) by default. This is OpenAI's recommended endpoint for new models and features. If you need the legacy Chat Completions endpoint for any reason, set:
