...
`uc_ai_utils` exposes the list of providers and model constants that UC AI ships with as pipelined table functions. Use them to build a provider/model picker in APEX (or any UI) without hard-coding each constant.
