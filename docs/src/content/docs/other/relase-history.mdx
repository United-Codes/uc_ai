...
To upgrade first run `v25.4_to_v25.5.sql` followed by `upgrade_packages.sql` script attached to the [GitHub release](https://github.com/United-Codes/uc_ai/releases/tag/v25.6).
