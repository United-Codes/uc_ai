create or replace package body uc_ai_openai as 
        ...
        when uc_ai.c_finish_reason_tool_calls then
          ...
          begin
            ...
            loop
              ...
              uc_ai_tools_api.before_tool_call(p_tool_code => l_tool_id, p_settings => p_settings);
   ...
   * - final_message: last message in conversation for simple usage. With a response
  ...
  begin
    ...
    if l_settings.enable_tools
      ...
      l_tools := uc_ai_tools_api.get_tools_array(uc_ai.c_provider_openai, l_settings.provider_override, p_tool_tags => l_settings.tool_tags, p_enable_tools => l_settings.enable_tools, p_provider_tools => l_settings.provider_tools, p_programmatic_tools => l_settings.enable_programmatic_tools);
