...
<CardGrid>
  <LinkCard
    ...
    description="Wrap a prompt profile as a trackable, composable agent"
...
**Keep everything, hide the agent.** Archiving is the usual choice. The agent
stops resolving, and every row stays:
