...
- [Anthropic Reasoning Best Practices](https://platform.claude.com/docs/en/build-with-claude/extended-thinking#best-practices-and-considerations-for-extended-thinking)
